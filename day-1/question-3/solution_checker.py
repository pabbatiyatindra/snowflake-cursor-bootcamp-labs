#!/usr/bin/env python3
"""Solution checker for Day 1, Question 3: Join Customers with Orders"""
...
def print_results(success: bool, message: str, results: Dict):
    ...
    print("\n" + "=" * 60)
    print("Solution Validator: Day 1, Question 3")
    print("=" * 60)
    ...
    if success:
        ...
        print("\nTroubleshooting:")
        print("-" * 40)
        print("1. Use LEFT JOIN (not INNER JOIN) to include all customers")
        print("2. GROUP BY all customer columns: customer_id, name, tier")
        print("3. Use COALESCE(SUM(o.amount), 0) for NULL handling")
        print("4. Order by total_spending DESC")
        print("\n" + "=" * 60 + "\n")
        return 1
